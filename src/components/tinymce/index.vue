<template>
      <div class="tinymce-box">
		<Editor id="yin" v-model="contentValue" :init="init" :disabled="disabled" @onClick="onClick" />
	</div>
</template>
...
export default {
      ...
      props: {
            ...
            plugins: {
                  type: [String, Array],
                  default: 'toc autoresize print preview searchreplace autolink directionality visualblocks visualchars fullscreen image link media template code codesample table charmap hr pagebreak nonbreaking anchor insertdatetime advlist lists wordcount textpattern autosave '
            },
            toolbar: {
                  type: [String, Array],
                  default: 'toc autoresize fullscreen undo redo restoredraft | cut copy paste pastetext | forecolor backcolor bold italic underline strikethrough link anchor | alignleft aligncenter alignright alignjustify outdent indent | \
      ...
      data(){
             return {
                  init: {
                        ...
                        body_class: 'my_class',
                        content_style: '.my_class{width: 300px;}',
      ...
      mounted(){
            ...
            // tinymce.editors['yin'].setMode('readonly');
